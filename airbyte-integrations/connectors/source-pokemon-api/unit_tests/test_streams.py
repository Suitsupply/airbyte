...
import pytest
from source_pokemon_api.source import PokemonApiStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(PokemonApiStream, "path", "v0/example_endpoint")
    mocker.patch.object(PokemonApiStream, "primary_key", "test_primary_key")
    mocker.patch.object(PokemonApiStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = PokemonApiStream()
